...
for font in font_list :
    os.mkdir(f"c:/Users/USER/Desktop/recognize_and_cut_single_test_initial/sentence_data_{font}")

    for i in range(49,58):
        source = f'C:/Users/USER/Desktop/동아리/글꼴 프로젝트/자료/문장 이미지 파일/문장_{font}/문장_{font}_{i}.png'
        destination = f'c:/Users/USER/Desktop/recognize_and_cut_single_test_initial/sentence_data_{font}/sentence_data_{font}_{i}.png'
        shutil.copyfile(source, destination)
"""

# test
for font in font_list :
    os.mkdir(f"c:/Users/USER/Desktop/recognize_and_cut_single_test_initial/sentence_test_result_{font}")

    for num in range(49,58) :
        img = Image.open(f'c:/Users/USER/Desktop/recognize_and_cut_single_test_initial/sentence_data_{font}/sentence_data_{font}_{num}.png')
        ...
        for n in range(len(contours)) :
            ...
            image_cut.save(f'c:/Users/USER/Desktop/recognize_and_cut_single_test_initial/sentence_test_result_{font}/sentence_test_result_{font}_{num}_cut_{n}.png')