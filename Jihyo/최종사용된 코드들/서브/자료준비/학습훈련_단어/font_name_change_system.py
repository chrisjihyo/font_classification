...
for font in range(len(font_list)) :
    ...
    for first in range (11172) :
                ...
                os.rename(f'c:/Users/USER/Desktop/동아리/글꼴 프로젝트/자료/글자 이미지 파일/글자_{font_list[font]}/글자_{font_list[font]}_{num}.png', 
                    f'c:/Users/USER/Desktop/동아리/글꼴 프로젝트/자료/글자 이미지 파일/이름변형본/{font_list_num[font]}/{word_list_first[first_num]}_{word_list_second[second_num]}_{word_list_third[third_num]}.{font_list_num[font]}.png')
